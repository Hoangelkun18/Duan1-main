                            ...
                            <div class="dropdown-menu py-0 dropdown-lg dropdown-menu-end"
                                ...
                                <div data-simplebar style="max-height: 280px;">
                                    ...
                                    <a href="javascript:void(0);" class="dropdown-item py-3 border-bottom text-wrap">
                                        <div class="d-flex">
                                            <div class="flex-shrink-0">
                                                <img src="/Duan1-main/public/admin/assets_admin/images/users/avatar-1.jpg"
                                    ...
                                    <a href="javascript:void(0);" class="dropdown-item py-3 border-bottom">
                                        <div class="d-flex">
                                            <div class="flex-shrink-0">
                                                <img src="/Duan1-main/public/admin/assets_admin/images/users/avatar-3.jpg"
                                    ...
                                    <a href="javascript:void(0);" class="dropdown-item py-3 border-bottom">
                                        <div class="d-flex">
                                            <div class="flex-shrink-0">
                                                <img src="/Duan1-main/public/admin/assets_admin/images/users/avatar-5.jpg"
                ...
                <ul class="navbar-nav" id="navbar-nav">
                        ...
                        <div class="collapse" id="sidebarProducts">
                            <ul class="nav sub-navbar-nav">
                                <li class="sub-nav-item">
                                    <a class="sub-nav-link" href="?act=product">List</a>
                                </li>
                                <li class="sub-nav-item">
                                    <a class="sub-nav-link" href="?act=product_edit">Edit</a>
                                </li>
                                <li class="sub-nav-item">
                                    <a class="sub-nav-link" href="?act=product_create">Create</a>
                                </li>
                            </ul>
                        </div>
                    </li>
                    ...
                    <li class="nav-item">
                        ...
                        <div class="collapse" id="sidebarCategory">
                            <ul class="nav sub-navbar-nav">
                                <li class="sub-nav-item">
                                    <a class="sub-nav-link" href="?act=category">List</a>
                                </li>
                                <li class="sub-nav-item">
                                    <a class="sub-nav-link" href="?act=category_edit">Edit</a>
                                </li>
                                <li class="sub-nav-item">
                                    <a class="sub-nav-link" href="?act=category_create">Create</a>
                                </li>
                            </ul>
                        </div>
                    </li>
