                                ...
                                <form>
                                    <div class="mb-3">
                                        ...
                                        <input type="text" id="category-title" class="form-control"
                                            placeholder="Enter Title" value="Fashion Men , Women & Kid's">
                                    </div>
                                </form>
                            </div>
                                ...
                                <form>
                                    <div class="mb-3">
                                        ...
                                        <input type="number" id="product-stock" class="form-control"
                                            placeholder="Quantity" value="46233">
                                    </div>
                            ...
                            <div class="col-lg-6">
                                <form>
                                    <div class="mb-3">
                                        ...
                                        <input type="text" id="product-id" class="form-control" placeholder="#******"
                                            value="FS16276">
                                    </div>
                            ...
                            <div class="col-lg-12">
                                <div class="mb-0">
                                    ...
                                    <textarea class="form-control bg-light-subtle" id="description" rows="7"
                                        placeholder="Type description">Aurora Fashion has once again captivated fashion enthusiasts with its latest collection, seamlessly blending elegance with comfort in a range of exquisite designs.</textarea>
                                </div>
                            </div>
                        </div>
                    </div>
                                ...
                                <form>
                                    <div class="mb-3">
                                        ...
                                        <input type="text" id="meta-title" class="form-control"
                                            placeholder="Enter Title" value="Fashion Brand">
                                    </div>
                                </form>
                            </div>
                            <div class="col-lg-6">
