    ...
    <div class="container-fluid">
        <div class="row align-items-center">
            <div class="col-2 d-none d-xl-block">
                <ul>
                    <li>
                        <a href="collection-left-sidebar.html">Women’s Clothing</a>
                    </li>
                    ...
                    <li>
                        <a href="collection-left-sidebar.html">Sports Accessories</a>
                    </li>
                    ...
                    <li>
                        <a href="collection-left-sidebar.html">Hair Accessories</a>
                    </li>
                        ...
                        <div>
                            ...
                            <div class="link-hover-anim underline">
                                <a class="btn btn_underline link-strong link-strong-unhovered"
                                    href="collection-left-sidebar.html">Show Now
                                    <svg>
                                        <use
                                ...
                                <div class="img-wrapper">
                                    ...
                                    <div class="product-image ratio_apos">
                                        <a class="pro-first" href="product.html">
                                            <img class="bg-img"
                                                src="/Duan1-main/public/client/assets/images/product/product-3/5.jpg"
                                                alt="product" /></a><a class="pro-sec" href="product.html">
                                            <img class="bg-img"
                                                src="/Duan1-main/public/client/assets/images/product/product-3/6.jpg"
                                                alt="product" /></a>
                                    </div>
                                    <div class="cart-info-icon">
                                        <a href="#" data-bs-toggle="modal" data-bs-target="#addtocart" tabindex="0"><i
                            ...
                            <div class="swiper-slide product-box-3">
                                <div class="img-wrapper">
                                    ...
                                    <div class="product-image ratio_apos">
                                        <a class="pro-first" href="product.html">
                                            <img class="bg-img"
                                                src="/Duan1-main/public/client/assets/images/product/product-3/8.jpg"
                                                alt="product" /></a><a class="pro-sec" href="product.html">
                                            <img class="bg-img"
                ...
                <div class="theme-tab-3">
                    <ul class="nav nav-tabs" role="tablist">
                        <li class="nav-item" role="presentation">
                            <a class="nav-link active" data-bs-toggle="tab" data-bs-target="#new-product" role="tab"
                                aria-controls="new-product" aria-selected="true">
                                <h6>New Products</h6>
                            </a>
                        </li>
                        <li class="nav-item" role="presentation">
                            <a class="nav-link" data-bs-toggle="tab" data-bs-target="#featured-product" role="tab"
                                aria-controls="featured-product" aria-selected="false">
                                <h6>Featured Products</h6>
                            </a>
                        </li>
                        <li class="nav-item" role="presentation">
                            <a class="nav-link" data-bs-toggle="tab" data-bs-target="#best-seller" role="tab"
                                aria-controls="best-seller" aria-selected="false">
                                <h6>Best Seller</h6>
                            </a>
                        </li>
                    </ul>
                                ...
                                <div class="product-box-3">
                                    <div class="img-wrapper">
                                        ...
                                        <div class="product-image">
                                            <a class="pro-first" href="product.html">
                                                <img class="bg-img"
                                                    src="/Duan1-main/public/client/assets/images/product/product-3/1.jpg"
                                                    alt="product" /></a><a class="pro-sec" href="product.html">
                                                <img class="bg-img"
                                ...
                                <div class="product-box-3">
                                    <div class="img-wrapper">
                                        ...
                                        <div class="product-image">
                                            <a class="pro-first" href="product.html">
                                                <img class="bg-img"
                                                    src="/Duan1-main/public/client/assets/images/product/product-3/2.jpg"
                                                    alt="product" /></a><a class="pro-sec" href="product.html">
                                                <img class="bg-img"
                                                    src="/Duan1-main/public/client/assets/images/product/product-3/19.jpg"
                                                    alt="product" /></a>
                                        </div>
                                        <div class="cart-info-icon">
                                            <a href="#" data-bs-toggle="modal" data-bs-target="#addtocart"
                                ...
                                <div class="product-box-3">
                                    <div class="img-wrapper">
                                        ...
                                        <div class="product-image">
                                            <a class="pro-first" href="product.html">
                                                <img class="bg-img"
                                                    src="/Duan1-main/public/client/assets/images/product/product-3/3.jpg"
                                                    alt="product" /></a><a class="pro-sec" href="product.html">
                                                <img class="bg-img"
                                        ...
                                        <div class="product-image">
                                            <a class="pro-first" href="product.html">
                                                <img class="bg-img"
                                                    ...
                                                    alt="product" /></a><a class="pro-sec" href="product.html">
                                                <img class="bg-img"
                                                    src="/Duan1-main/public/client/assets/images/product/product-3/21.jpg"
                                                    alt="product" /></a>
                                        </div>
                                        <div class="cart-info-icon">
                                            <a href="#" data-bs-toggle="modal" data-bs-target="#addtocart"
                                ...
                                <div class="product-box-3">
                                    <div class="img-wrapper">
                                        ...
                                        <div class="product-image">
                                            <a class="pro-first" href="product.html">
                                                <img class="bg-img"
                                                    src="/Duan1-main/public/client/assets/images/product/product-3/4.jpg"
                                                    alt="product" /></a><a class="pro-sec" href="product.html">
                                                <img class="bg-img"
                                        ...
                                        <div class="product-image">
                                            <a class="pro-first" href="product.html">
                                                <img class="bg-img"
                                                    ...
                                                    alt="product" /></a><a class="pro-sec" href="product.html">
                                                <img class="bg-img"
                                                    src="/Duan1-main/public/client/assets/images/product/product-3/15.jpg"
                                                    alt="product" /></a>
                                        </div>
                                        <div class="cart-info-icon">
                                            <a href="#" data-bs-toggle="modal" data-bs-target="#addtocart"
                                        ...
                                        <div class="product-image">
                                            <a class="pro-first" href="product.html">
                                                <img class="bg-img"
                                                    ...
                                                    alt="product" /></a><a class="pro-sec" href="product.html">
                                                <img class="bg-img"
                                                    src="/Duan1-main/public/client/assets/images/product/product-3/14.jpg"
                                                    alt="product" /></a>
                                        </div>
                                        <div class="cart-info-icon">
                                            <a href="#" data-bs-toggle="modal" data-bs-target="#addtocart"
                                        ...
                                        <div class="product-image">
                                            <a class="pro-first" href="product.html">
                                                <img class="bg-img"
                                                    ...
                                                    alt="product" /></a><a class="pro-sec" href="product.html">
                                                <img class="bg-img"
                                                    src="/Duan1-main/public/client/assets/images/product/product-3/13.jpg"
                                                    alt="product" /></a>
                                        </div>
                                        <div class="cart-info-icon">
                                            <a href="#" data-bs-toggle="modal" data-bs-target="#addtocart"
                                ...
                                <div class="product-box-3">
                                    <div class="img-wrapper">
                                        ...
                                        <div class="product-image">
                                            <a class="pro-first" href="product.html">
                                                <img class="bg-img"
                                                    src="/Duan1-main/public/client/assets/images/product/product-3/17.jpg"
                                                    alt="product" /></a><a class="pro-sec" href="product.html">
                                                <img class="bg-img"
                                                    src="/Duan1-main/public/client/assets/images/product/product-3/1.jpg"
                                                    alt="product" /></a>
            ...
            <div class="row gy-4 align-items-end">
                <div class="col-sm-6 col-12 ratio_square-4">
                    <a href="collection-left-sidebar.html">
                        <img class="bg-img" src="/Duan1-main/public/client/assets/images/banner/banner-4.png"
                            alt="" /></a>
                </div>
                <div class="col-sm-6 col-12 ratio3_2">
                    ...
                    <a href="collection-left-sidebar.html">
                        <img class="bg-img" src="/Duan1-main/public/client/assets/images/banner/banner-5.jpg"
                            alt="" /></a>
                </div>
            </div>
        </div> -->
        ...
        <div class="row gy-3">
            <div class="col-12">
                <div class="d-sm-flex d-block justify-content-between align-items-center">
                    ...
                    <div class="link-hover-anim underline">
                        <a class="btn btn_underline link-strong link-strong-unhovered"
                            href="collection-left-sidebar.html">See All Product
                            <svg>
                ...
                <div class="row gy-4">
                    <div class="col-lg-12 col-md-6 col-12">
                        <div class="flash-content">
                            <img class="img-fluid" src="/Duan1-main/public/client/assets/images/banner/6.jpg" alt="" />
                            <div>
                                <ul>
                                    <li>
                                        <svg>
                                            <use
                                                href="https://themes.pixelstrap.net/katie/assets/svg/icon-sprite.svg#star">
                                            </use>
                                        </svg>
                                    </li>
                                    <li>
                    ...
                    <div class="col-lg-12 col-md-6 col-12">
                        <div class="flash-content">
                            <img class="img-fluid" src="/Duan1-main/public/client/assets/images/banner/7.jpg" alt="" />
                            <div>
                                <ul>
                                    <li>
                                        <svg>
            ...
            <div class="col-xxl-6 col-lg-6 col-12 order-xxl-2 order-1">
                <div class="flash-images ratio50_2">
                    <a href="collection-left-sidebar.html"><img class="bg-img"
                            src="/Duan1-main/public/client/assets/images/banner/banner-10.jpg" alt="" /></a>
                    <div class="banner-2">
                        <h3>40% - 80%Off</h3>
            ...
            <div class="col-xxl-3 col-12 order-xxl-3 order-3">
                <div class="row gy-4">
                    <div class="col-xxl-12 col-md-6 col-12">
                        <div class="flash-content">
                            <img class="img-fluid" src="/Duan1-main/public/client/assets/images/banner/8.jpg" alt="" />
                            <div>
                                <ul>
                                    <li>
                                        <svg>
                    ...
                    <div class="col-xxl-12 col-md-6 col-12">
                        <div class="flash-content">
                            <img class="img-fluid" src="/Duan1-main/public/client/assets/images/banner/9.jpg" alt="" />
                            <div>
                                <ul>
                                    <li>
                                        <svg>
            ...
            <div class="col-sm-3 col-6">
                <div class="brand-logo-txt">
                    <div>
                        ...
                        <h4>Up to 40% off</h4>
                        <div class="link-hover-anim underline">
                            <a class="btn btn_underline link-strong link-strong-unhovered" href="index.html">Shop Now
                                <svg>
                                    <use href="https://themes.pixelstrap.net/katie/assets/svg/icon-sprite.svg#arrow">
                                    </use>
                                </svg></a><a class="btn btn_underline link-strong link-strong-hovered"
                                href="index.html">Shop Now
                                <svg>
                                    <use href="https://themes.pixelstrap.net/katie/assets/svg/icon-sprite.svg#arrow">
                                    </use>
                                </svg></a>
                ...
                <div class="swiper slide-2">
                    <div class="swiper-wrapper">
                        <div class="swiper-slide logo-block">
                            <a href="collection-left-sidebar.html">
                                <img src="/Duan1-main/public/client/assets/images/logos/1.png" alt="logo" /></a>
                        </div>
                        <div class="swiper-slide logo-block">
                            <a href="collection-left-sidebar.html">
                                <img src="/Duan1-main/public/client/assets/images/logos/2.png" alt="logo" /></a>
                        </div>
                        <div class="swiper-slide logo-block">
                            <a href="collection-left-sidebar.html">
                                <img src="/Duan1-main/public/client/assets/images/logos/3.png" alt="logo" /></a>
                        </div>
                        <div class="swiper-slide logo-block">
                            <a href="collection-left-sidebar.html">
                                <img src="/Duan1-main/public/client/assets/images/logos/4.png" alt="logo" /></a>
                        </div>
                        <div class="swiper-slide logo-block">
                            <a href="collection-left-sidebar.html">
                                <img src="/Duan1-main/public/client/assets/images/logos/5.png" alt="logo" /></a>
                        </div>
                        <div class="swiper-slide logo-block">
                            <a href="collection-left-sidebar.html">
                                <img src="/Duan1-main/public/client/assets/images/logos/6.png" alt="logo" /></a>
                        </div>
                        <div class="swiper-slide logo-block">
                            <a href="collection-left-sidebar.html">
                                <img src="/Duan1-main/public/client/assets/images/logos/7.png" alt="logo" /></a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="row align-items-center">
            <div class="col-xl-8 col-md-7 col-12 px-0">
                <a href="index.html"><img class="bg-img"
                        src="/Duan1-main/public/client/assets/images/banner/banner-6.png" alt="" /></a>
            </div>
            <div class="col-xl-4 col-5">
                <div class="subscribe-content">
                    ...
                    <div class="link-hover-anim underline">
                        <a class="btn btn_underline link-strong link-strong-unhovered" href="index.html">Subscribe Now
                            <svg>
                                <use href="https://themes.pixelstrap.net/katie/assets/svg/icon-sprite.svg#arrow"></use>
                            </svg></a><a class="btn btn_underline link-strong link-strong-hovered"
                            href="index.html">Subscribe Now
                            <svg>
                                <use href="https://themes.pixelstrap.net/katie/assets/svg/icon-sprite.svg#arrow"></use>
                            </svg></a>
                    </div>
            ...
            <div class="swiper-wrapper">
                    ...
                    <div class="instagram-box-1">
                        <div class="instagram-box">
                            <div class="instashop-effect">
                                <img src="/Duan1-main/public/client/assets/images/instagram/6.jpg" alt="" />
                                <div class="insta-txt">
                                    <div>
                ...
                <div class="swiper-slide">
                    <div class="instagram-box-1">
                        <div class="instagram-box">
                            <div class="instashop-effect">
                                <img src="/Duan1-main/public/client/assets/images/instagram/7.jpg" alt="" />
                                <div class="insta-txt">
                                    <div>
                                        <svg class="insta-icon">
                                            <use
                ...
                <div class="swiper-slide">
                    <div class="instagram-box-1">
                        <div class="instagram-box">
                            <div class="instashop-effect">
                                <img src="/Duan1-main/public/client/assets/images/instagram/8.jpg" alt="" />
                                <div class="insta-txt">
                                    <div>
                                        <svg class="insta-icon">
                                            <use
                ...
                <div class="swiper-slide">
                    <div class="instagram-box-1">
                        <div class="instagram-box">
                            <div class="instashop-effect">
                                <img src="/Duan1-main/public/client/assets/images/instagram/9.jpg" alt="" />
                                <div class="insta-txt">
                                    <div>
                                        <svg class="insta-icon">
                                            <use
                ...
                <div class="swiper-slide">
                    <div class="instagram-box-1">
                        <div class="instagram-box">
                            <div class="instashop-effect">
                                <img src="/Duan1-main/public/client/assets/images/instagram/10.jpg" alt="" />
                                <div class="insta-txt">
                                    <div>
                                        <svg class="insta-icon">
                                            <use
