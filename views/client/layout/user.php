                    ...
                    <div class="profile-box">
                        ...
                        <div class="profile-contain">
                            <div class="profile-image"> <img class="img-fluid"
                                    src="/Duan1-main/public/client/assets/images/user/12.jpg" alt=""></div>
                        ...
                        <li>
                            <button class="nav-link active" id="dashboard-tab" data-bs-toggle="pill"
                                data-bs-target="#dashboard" role="tab" aria-controls="dashboard" aria-selected="true"><i
                                    class="iconsax" data-icon="home-1"></i> Dashboard</button>
                        </li>
                        <li>
                            ...
                            <div class="my-dashboard-tab">
                                ...
                                <div class="dashboard-user-name">
                                    ...
                                    <p>My dashboard provides a comprehensive overview of key metrics and data relevant
                                        to your operations. It offers real-time insights into performance, including
                                        sales figures, website traffic, customer engagement, and more. With customizable
                                        widgets and intuitive visualizations, it facilitates quick decision-making and
                                        allows you to track progress towards your goals effectively.</p>
                                </div>
                                <div class="total-box">
                                    <div class="row gy-4">
                                        <div class="col-xl-4">
                                ...
                                <ul class="notification-body">
                                    <li>
                                        <div class="user-img"> <img
                                                src="/Duan1-main/public/client/assets/images/notification/1.jpg" alt="">
                                        </div>
                                        <div class="user-contant">
                                            ...
                                            <p>A quick weekend trip, a staycation in your own town, or a weeklong vacay
                                                with the family—it’s your choice if it’s in the budget. No matter what
                                                you plan on doing during spring break, budget ahead for it.</p>
                                        </div>
                                    </li>
                                    <li>
                                        <div class="user-img"> <img
                                                src="/Duan1-main/public/client/assets/images/notification/2.jpg" alt="">
                                        </div>
                                        <div class="user-contant">
                                    ...
                                    <li>
                                        <div class="user-img"> <img
                                                src="/Duan1-main/public/client/assets/images/notification/3.jpg" alt="">
                                        </div>
                                        <div class="user-contant">
                                            <h6>Figma - Move work forward<span>2:14PM</span></h6>
                                            <p>Hello, Everyone understands why a new language would be advantageous: one
                                                could refuse to pay for high-priced translators.</p>
                                        </div>
                                    </li>
                                    <li>
                                        <div class="user-img"> <img
                                                src="/Duan1-main/public/client/assets/images/notification/4.jpg" alt="">
                                        </div>
                                        <div class="user-contant">
                                            <h6>Trip Reminder.<span>2:14PM</span></h6>
                                            <p>I'm sorry, but I have to disagree with Mr. Zingier. We are all aware that
                                                the title is the most crucial component of any article. Your reader
                                                won't even make it to the first sentence without an engaging title. </p>
                                        </div>
                                    </li>
                                    <li>
                                        <div class="user-img"> <img
                                                src="/Duan1-main/public/client/assets/images/notification/5.jpg" alt="">
                                        </div>
                                        <div class="user-contant">
                                            <h6>Flipkart - Confirmed order<span>2:14PM</span></h6>
                                            <p>Thanks for signing up for CodePen! We're happy you're here. Let's get
                                    ...
                                    <li>
                                        <div class="user-img"> <img
                                                src="/Duan1-main/public/client/assets/images/notification/6.jpg" alt="">
                                        </div>
                                        <div class="user-contant">
                                            <h6>Flipkart - Confirmed order<span>2:14PM</span></h6>
                                            <p>Thanks for signing up for CodePen! We're happy you're here. Let's get
                                    ...
                                    <li>
                                        <div class="user-img"> <img
                                                src="/Duan1-main/public/client/assets/images/notification/7.jpg" alt="">
                                        </div>
                                        <div class="user-contant">
                                            <h6>Figma - Move work forward<span>2:14PM</span></h6>
                                            <p>Hello, Everyone understands why a new language would be advantageous: one
                                    ...
                                    <li>
                                        <div class="user-img"> <img
                                                src="/Duan1-main/public/client/assets/images/notification/8.jpg" alt="">
                                        </div>
                                        <div class="user-contant">
                                            <h6>Trip Reminder.<span>2:14PM</span></h6>
                                            <p>I'm sorry, but I have to disagree with Mr. Zingier. We are all aware that
                                    ...
                                    <li>
                                        <div class="user-img"> <img
                                                src="/Duan1-main/public/client/assets/images/notification/9.jpg" alt="">
                                        </div>
                                        <div class="user-contant">
                                            <h6>Flipkart - Confirmed order<span>2:14PM</span></h6>
                                            <p>Thanks for signing up for CodePen! We're happy you're here. Let's get
                                    ...
                                    <li>
                                        <div class="user-img"> <img
                                                src="/Duan1-main/public/client/assets/images/notification/10.jpg"
                                                alt="">
                                        </div>
                                        <div class="user-contant">
                                            <h6>Flipkart - Confirmed order<span>2:14PM</span></h6>
                                    ...
                                    <li>
                                        <div class="user-img"> <img
                                                src="/Duan1-main/public/client/assets/images/notification/11.jpg"
                                                alt="">
                                        </div>
                                        <div class="user-contant">
                                            <h6>Figma - Move work forward<span>2:14PM</span></h6>
                                    ...
                                    <li>
                                        <div class="user-img"> <img
                                                src="/Duan1-main/public/client/assets/images/notification/12.jpg"
                                                alt="">
                                        </div>
                                        <div class="user-contant">
                                            <h6>Trip Reminder.<span>2:14PM</span></h6>
                                        ...
                                        <div class="product-box-3 product-wishlist">
                                            <div class="img-wrapper">
                                                ...
                                                <div class="cart-info-icon"> <a href="#" data-bs-toggle="modal"
                                                        ...
                                                        </i></a><a href="compare.html" title="Compare" tabindex="0"><i
                                ...
                                <div class="row gy-4">
                                    ...
                                    <div class="col-12">
                                        <div class="order-box">
                                            ...
                                            <div class="product-order-detail">
                                                <div class="product-box"> <a href="product.html"> <img
                                                            src="/Duan1-main/public/client/assets/images/notification/9.jpg"
                                                            alt=""></a>
                                                    <div class="order-wrap">
                                                        <h5>Rustic Minidress with Halterneck</h5>
                                                        <p>Versatile sporty slogans short sleeve quirky laid back orange
                                    ...
                                    <div class="col-12">
                                        <div class="order-box">
                                            ...
                                            <div class="product-order-detail">
                                                <div class="product-box"> <a href="product.html"> <img
                                                            src="/Duan1-main/public/client/assets/images/notification/2.jpg"
                                                            alt=""></a>
                                                    <div class="order-wrap">
                                                        <h5>Rustic Minidress with Halterneck</h5>
                                                        <p>Versatile sporty slogans short sleeve quirky laid back orange
                                    ...
                                    <div class="col-12">
                                        <div class="order-box">
                                            ...
                                            <div class="product-order-detail">
                                                <div class="product-box"> <a href="product.html"> <img
                                                            src="/Duan1-main/public/client/assets/images/notification/6.jpg"
                                                            alt=""></a>
                                                    <div class="order-wrap">
                                                        <h5>Rustic Minidress with Halterneck</h5>
                                                        <p>Versatile sporty slogans short sleeve quirky laid back orange
                                ...
                                <div class="payment-section">
                                    <div class="row gy-3">
                                        <div class="col-xxl-4 col-md-6">
                                            <div class="payment-card">
                                                <div class="bank-info"><img class="bank"
                                                        src="/Duan1-main/public/client/assets/images/bank-card/bank1.png"
                                                        alt="bank1">
                                                    <div class="card-type"><img class="bank-card"
                                                            src="/Duan1-main/public/client/assets/images/bank-card/1.png"
                                                            alt="card"></div>
                                                </div>
                                        ...
                                        <div class="col-xxl-4 col-md-6">
                                            <div class="payment-card">
                                                <div class="bank-info"><img class="bank"
                                                        src="/Duan1-main/public/client/assets/images/bank-card/bank2.png"
                                                        alt="bank1">
                                                    <div class="card-type"><img class="bank-card"
                                                            src="/Duan1-main/public/client/assets/images/bank-card/2.png"
                                                            alt="card"></div>
                                                </div>
                                                <div class="card-details"><span>Card Number</span>
                                                    <h5>6458 50XX XXXX 0851</h5>
                                        ...
                                        <div class="col-xxl-4 col-md-6">
                                            <div class="payment-card">
                                                <div class="bank-info"><img class="bank"
                                                        src="/Duan1-main/public/client/assets/images/bank-card/bank3.png"
                                                        alt="bank1">
                                                    <div class="card-type"><img class="bank-card"
                                                            src="/Duan1-main/public/client/assets/images/bank-card/3.png"
                                                            alt="card"></div>
                                                </div>
                                                <div class="card-details"><span>Card Number</span>
                                                    <h5>6458 50XX XXXX 0851</h5>
                        ...
                        <div class="dashboard-right-box">
                            <div class="address-tab">
                                        ...
                                        <div class="address-option">
                                            <label for="address-billing-0"> <span class="delivery-address-box"> <span
                                                    ...
                                                    class="buttons"> <a class="btn btn_black sm" href="#"
                                                        ...
                                                        tabindex="0">Delete </a></span></label>
                                        </div>
                                    </div>
                                    <div class="col-xxl-4 col-md-6">
                                        <div class="address-option">
                                ...
                                <button class="btn add-address" data-bs-toggle="modal" data-bs-target="#add-address"
                                    title="Quick View" tabindex="0">+ Add Address</button>
                            </div>
                        </div>
                    </div>
