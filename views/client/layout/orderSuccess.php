    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-12 px-0">
                <div class="order-box-1"><img src="/Duan1-main/public/client/assets/images/gif/success.gif" alt="">
                    <h4>Order Success</h4>
        ...
        <div class="row gy-4">
            <div class="col-xl-8">
                <div class="order-items sticky">
                    ...
                    <p>Order invoice has been send to your registered email account. double check your order details
                    </p>
            ...
            <div class="col-xl-4">
                <div class="summery-box">
                    ...
                    <div class="summery-content">
                        ...
                        <div class="note-box">
                            <p>I'm hoping the store can work with me to get it delivered as soon as possible because I
                                really need it to gift to my friend for her party next week.Many thanks for it.</p>
                        </div>
                    </div>
                </div>
